...
/** @type {string} */
const CACHE_VERSION = '1731787208|64437218173';
/** @type {string} */
const CACHE_PREFIX = 'Isofar Companion-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Isofar Companion V5.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Isofar Companion V5.html","Isofar Companion V5.js","Isofar Companion V5.offline.html","Isofar Companion V5.icon.png","Isofar Companion V5.apple-touch-icon.png","Isofar Companion V5.worker.js","Isofar Companion V5.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Isofar Companion V5.wasm","Isofar Companion V5.pck"];
